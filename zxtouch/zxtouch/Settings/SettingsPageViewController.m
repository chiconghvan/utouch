...
- (void)reloadSettingsModel {
    ...
    cellsForEachSection = @[
        ...
        @[
            @{@"type": @(SETTING_CELL_ENTRY), @"title": @"ZXTouch Rootless 0.3.52", @"secondary_title": @"iOS 15-17 port by Epic0001", @"row_click_handler": NSStringFromSelector(@selector(handleCreditsTap:))}
        ]
    ];
